...
st.markdown(f"""
    ...
    /* Espaço para o header fixo e para evitar o rodapé colar no fim no mobile */
    section.main > div.block-container {{
        position: relative;
        z-index: 1;
        padding-top: 120px;   /* será reduzido no mobile abaixo */
        padding-bottom: 16px;
    }}
    ...
    .nav a, .nav .dropdown > a {{
        ...
        -webkit-tap-highlight-color: transparent; /* melhora toque no mobile */
    }}
    .nav a:hover {{
    ...
    /* Barra de controles (estética + responsivo) */
    .controls-bar {{
    ...
    @media (max-width: 768px) {{
        ...
        /* Empilha as colunas do Streamlit no mobile */
...
st.markdown(
    ...
    "<p class='lead' style='text-align:center;color:gray;margin-top:0;'>Transforme dados entre latitude/longitude, UTM e GMS</p>",
    unsafe_allow_html=True
)
