...
uploaded_file = st.file_uploader("📁 Envie seu arquivo CSV com colunas 'latitude' e 'longitude'", type="csv", key="upload_csv_unico")
...
if uploaded_file:
    ...
    if 'latitude' in df.columns and 'longitude' in df.columns:
        ...
        # Converte todas as coordenadas com duas casas decimais
